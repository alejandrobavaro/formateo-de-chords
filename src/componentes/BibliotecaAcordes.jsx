...
import BibliotecaChordDiagram from "./BibliotecaChordDiagram";
import "../assets/scss/_03-Componentes/_BibliotecaAcordes.scss";

const BibliotecaAcordes = () => {
      ...
      <div className="chord-detail-modal">
        <div className="chord-detail-content" ref={modalRef}>
          ...
          <div className="chord-detail-body">
            <BibliotecaChordDiagram fingering={selectedChord.fingering} />
            ...
            : filteredChords.map((chord, index) => (
              <div key={index} className="chord-item" onClick={() => handleChordSelect(chord)}>
                <div className="chord-diagram-wrapper">
                  <BibliotecaChordDiagram fingering={chord.fingering} />
                </div>
...
export default BibliotecaAcordes;